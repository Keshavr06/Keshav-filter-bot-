...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '6285713858').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002428058754') #Channel / Group Id for force sub ( make sure bot is admin )
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_downlod_7/12') # Tutorial video link for opening shortlink website 
